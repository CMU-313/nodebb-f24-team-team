...
define('composer/formatting', ['composer/preview', 'composer/resize', 'topicThumbs', 'screenfull'], (preview, resize, topicThumbs, screenfull) => {
	const formatting = {};
	...
	function generateFormattingDropdown(btn) {
		const dropdownItemsHtml = btn.dropdownItems.map(btn => `
				<li>
