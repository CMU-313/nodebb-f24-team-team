...
define('composer/autocomplete', ['composer/preview', '@textcomplete/core', '@textcomplete/textarea', '@textcomplete/contenteditable'], (preview, {
	Textcomplete,
}, {
	TextareaEditor,
}, {
	...
	$(window).on('action:composer.discard', (evt, data) => {
	...
	autocomplete.init = function (postContainer, post_uuid) {
       ...
       */
		...
		data.element.on('textComplete:select', () => {
